...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Robotics Club — Build. Innovate. Engineer." },
      { name: "twitter:description", content: "Robotics Club is a build-first engineering ecosystem where students design, develop, and deploy intelligent robotics systems." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4dfb0f0a-5b60-43f3-909b-d346625ed4e9/id-preview-4f2ff722--5d76bdfe-6cd5-4b36-9b3e-b90691f64aca.lovable.app-1782411258601.png" },
